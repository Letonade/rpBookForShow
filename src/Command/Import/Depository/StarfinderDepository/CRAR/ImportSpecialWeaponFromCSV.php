...
class ImportSpecialWeaponFromCSV extends CSVImportHelper
{
    const FILE_ACCESS_PATH = '/Depository/Starfinder/CRAR/SpecialWeapon.csv';
    protected static $defaultName = 'app:import:add:sf:crar:spcw';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($this->saColl as $row) {
            ...
            $this->importsLogger->info('[' . $count . ']Persisted spcw: ' . $sw->getName());
        }
