...
class ImportLightArmorFromCSV extends CSVImportHelper
{
    const FILE_ACCESS_PATH = '/Depository/Starfinder/CRAR/LightArmor.csv';
    protected static $defaultName = 'app:import:add:sf:crar:light-armor';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($this->saColl as $row) {
            $count++;
            $lightArmor = $this->composeFromRow($row);
            $this->documentManager->persist($lightArmor);
            $this->importsLogger->info('[' . $count . ']Persisted light armor : ' . $lightArmor->getName());
        }
