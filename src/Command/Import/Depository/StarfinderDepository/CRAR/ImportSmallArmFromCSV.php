...
class ImportSmallArmFromCSV extends CSVImportHelper
{
    const FILE_ACCESS_PATH = '/Depository/Starfinder/CRAR/SmallArm.csv';
    protected static $defaultName = 'app:import:add:sf:crar:sa';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($this->saColl as $row) {
            $count++;
            $sa = $this->composeFromRow($row);
            $this->documentManager->persist($sa);
            $this->importsLogger->info('[' . $count . ']Persisted sa: ' . $sa->getName());
        }
