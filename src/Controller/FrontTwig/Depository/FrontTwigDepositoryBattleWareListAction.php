...
class FrontTwigDepositoryBattleWareListAction extends AbstractController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        if (!$itemTypeDesc instanceof RpItemTypeDescription) {throw new Exception('Item type description not found.');}
        ...
        return $this->render('Depository/battleWareList.html.twig', [
            'typeTable'  => $typeTable,
