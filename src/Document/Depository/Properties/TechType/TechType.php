...
namespace App\Document\Depository\Properties\TechType;
...
/**
 * @MongoDB\Document(collection="TechTypes", repositoryClass="App\Repository\Depository\TechTypeRepository")
 */
class TechType implements DocumentWithExtrafieldsInterface, DocumentWithCustomfieldsInterface
{
    use DocumentWithExtrafieldsTrait;
    use DocumentWithCustomfieldsTrait;

    public const DOCUMENT_NAME = 'TechType';
    ...
    /**
     * @var string
     * @MongoDB\Field(type="string", name="badge_class")
     */
    private $badgeClass;
